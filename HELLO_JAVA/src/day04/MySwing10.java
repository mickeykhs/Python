...
public class MySwing10 extends JFrame {
	...
	public MySwing10() {
		...
		lbl.setBounds(46, 31, 70, 18);
		contentPane.add(lbl);
		
		tf = new JTextField();
		tf.setBounds(156, 30, 82, 21);
		contentPane.add(tf);
		tf.setColumns(10);
		...
		btn.setBounds(46, 68, 115, 23);
		contentPane.add(btn);
		
		ta = new JTextArea();
		ta.setBounds(45, 101, 193, 303);
		contentPane.add(ta);
		...
		btnReset.setBounds(166, 68, 70, 23);
		contentPane.add(btnReset);
		
		setCom();
	}
//	public String myreset() {
//		ta.setText("");
//		tf.setText("");
//		int compu = (int) (Math.random()*900)+100;
//		String com = Integer.toString(compu);
//		return com;
//	}
	public void myreset() {
		ta.setText("");
	...
	public int getBall(String com, String mine) {
		...
		if(c2.equals(m3)||c2.equals(m1)) cnt++;
	...
	public void myclick() {
		...
		if(s == 3) {
			JOptionPane.showMessageDialog(null, mine + "를 맞췄습니다.");
		}
	}
